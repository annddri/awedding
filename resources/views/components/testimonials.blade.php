<section id="testimoni" class="py-20 lg:py-28 bg-slate-900 text-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center max-w-3xl mx-auto space-y-4">
            <span class="text-xs uppercase font-bold tracking-widest text-amber-400 bg-amber-500/10 border border-amber-500/20 px-3 py-1 rounded-full">
                Kisah Kebahagiaan
            </span>
            <h2 class="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-white">
                Kata Pasangan Yang Telah Memakai <span class="gold-gradient-text">Awedding</span>
            </h2>
            <p class="text-slate-400 text-base sm:text-lg">
                Kepuasan pasangan dan kemudahan tamu saat menghadiri hari bahagia Anda adalah prioritas utama kami.
            </p>
        </div>
        ...
        <div class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-slate-800/80 backdrop-blur-md p-7 rounded-3xl border border-slate-700/80 flex flex-col justify-between space-y-6 hover:border-amber-500/50 transition-colors">
                ...
                <div class="flex items-center space-x-4 pt-4 border-t border-slate-700/50">
                    ...
                    <div>
                        <h4 class="font-bold text-sm text-white">Rizky & Amanda</h4>
                        <p class="text-xs text-amber-400 font-medium">Bandung — Oktober 2026</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-slate-800/80 backdrop-blur-md p-7 rounded-3xl border border-slate-700/80 flex flex-col justify-between space-y-6 hover:border-amber-500/50 transition-colors">
                ...
                <div class="flex items-center space-x-4 pt-4 border-t border-slate-700/50">
                    ...
                    <div>
                        <h4 class="font-bold text-sm text-white">Dimas & Fitri</h4>
                        <p class="text-xs text-amber-400 font-medium">Jakarta — September 2026</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-slate-800/80 backdrop-blur-md p-7 rounded-3xl border border-slate-700/80 flex flex-col justify-between space-y-6 hover:border-amber-500/50 transition-colors">
                ...
                <div class="flex items-center space-x-4 pt-4 border-t border-slate-700/50">
                    ...
                    <div>
                        <h4 class="font-bold text-sm text-white">Bagus & Siska</h4>
                        <p class="text-xs text-amber-400 font-medium">Surabaya — Agustus 2026</p>
                    </div>
                </div>
            </div>
